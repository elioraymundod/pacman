Public Class Nivel3
    ...
    Private Sub VerificarBolitas()
        ...
        If (BolitasComidas = 280) Then

            If (Pacman.Bounds.IntersectsWith(PictureBox282.Bounds) And PictureBox282.Visible = True) Then
                PictureBox259.Visible = True
                PictureBox282.Visible = False
            End If

            If (Pacman.Bounds.IntersectsWith(PictureBox259.Bounds) And PictureBox259.Visible = True) Then
                PictureBox95.Visible = True
                PictureBox259.Visible = False
            End If

            If (Pacman.Bounds.IntersectsWith(PictureBox95.Bounds) And PictureBox95.Visible = True) Then
                PictureBox242.Visible = True
                PictureBox95.Visible = False
            End If

            If (Pacman.Bounds.IntersectsWith(PictureBox242.Bounds) And PictureBox242.Visible = True) Then
                PictureBox283.Visible = True
                PictureBox242.Visible = False
            End If

            If (Pacman.Bounds.IntersectsWith(PictureBox283.Bounds) And PictureBox283.Visible = True) Then
                xPacman = 46
                yPacman = 454
                Pacman.Location = New Point(xPacman, yPacman)
                PictureBox283.Visible = False

                BolitasComidas = 0
                MsgBox("¡¡NIVEL 3 SUPERADO!!")

                PartidaGanada.ObtenerPunteo(Puntaje)
                PartidaGanada.Show()
                Me.Visible = False
        ...
        If (BolitasComidas = 278) Then
            PictureBox282.Visible = True
            BolitasComidas = 280
            Exit Sub
        End If
    ...
    Private Sub Juego_Tick(sender As Object, e As EventArgs) Handles Juego.Tick
        ...
        If (tiempoJuego = 30) Then
            PictureBox1.Visible = True
        End If
        If (tiempoJuego = 45) Then
    ...
    Private Sub PictureBox285_Click(sender As Object, e As EventArgs) Handles PictureBox285.Click
        Form1.Show()
        Me.Close()
    End Sub

    Private Sub PictureBox284_Click(sender As Object, e As EventArgs) Handles PictureBox284.Click
        Me.Close()
        Nivel2.Close()
